...
# -----------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='PyTorch video prediction model - RAP-Cell-h')
...
parser.add_argument('--save_dir', type=str, default='../model_lib/cikm_rap_cell_h')
parser.add_argument('--gen_frm_dir', type=str, default='/mnt/A/meteorological/2500_ref_seq/CIKM_rap_cell_h_test/')
...
# model
parser.add_argument('--model_name', type=str, default='rap_cell_h')
